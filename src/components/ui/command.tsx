...
function CommandDialog({
  ...
  return (
    <Dialog {...props}>
      ...
      <DialogContent
        className={cn("rounded-3xl! p-0 overflow-hidden p-0", className)}
...
function CommandInput({
  ...
  return (
    <div data-slot="command-input-wrapper" className="p-1 pb-0">
      <InputGroup className="bg-input/30 h-9 focus-within:outline-none focus-within:ring-primary focus-within:ring-1 focus-within:border-primary/30">
...
function CommandGroup({
  ...
  return (
    <CommandPrimitive.Group
      ...
      className={cn("text-foreground **:[[cmdk-group-heading]]:text-muted-foreground overflow-hidden p-1 [&_[cmdk-group-heading]]:px-3 [&_[cmdk-group-heading]]:py-2 [&_[cmdk-group-heading]]:text-xs [&_[cmdk-group-heading]]:font-medium", className)}
      {...props}
    />
  )
}
