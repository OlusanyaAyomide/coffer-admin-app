...
export type ReturnPayoutStrategy =
  | 'at_maturity'
  | 'upfront'
  | 'recurring'
...
export type AdminInvestmentSummary = {
  ...
  upfront_return_percentage: string | null
  start_date: string
  maturity_date: string
...
export type InvestmentScheduleDateOverrideInput = {
  schedule_key: string
  payment_date: string
}
...
export type UpdateDividendSchedulesBody = {
  schedules: Array<{ id: string; payment_date: string }>
}
